...
public class Session {
    ...
    //syncronized no usar para evitar problemas de ejecucion paralela
    ...
    public void swipe () throws MalformedURLException {
        ...
        Label startControl = new Label(By.xpath("//android.widget.ViewAnimator/android.widget.ListView[1]/android.widget.TextView"));
        Label endControl = new Label(By.xpath("//android.widget.ViewAnimator/android.widget.ListView[23]/android.widget.TextView"));
